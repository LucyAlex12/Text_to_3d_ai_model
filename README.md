...
5. Optional: add a Hugging Face token as `HF_TOKEN` for faster model downloads and higher rate limits.
6. Run the notebook cells from top to bottom.
7. Open the printed ngrok URL in a normal browser tab, not Colab's iframe preview.
